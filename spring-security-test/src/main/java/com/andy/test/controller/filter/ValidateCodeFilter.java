package com.andy.test.controller.filter;

import com.andy.test.common.ValidateCodeException;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        String[] strUrls = appSecurityProperties.getCode().getImage().getUrl().split(",");
...
//        sessionStrategy.removeAttribute(request, ValidateCodeController.SESSION_KEY);
    ...
    public AppSecurityProperties getAppSecurityProperties() {
        return appSecurityProperties;
    }

    public void setAppSecurityProperties(AppSecurityProperties appSecurityProperties) {
